...
describe('useChildrenQuery', () => {
  ...
  it('odebere dítě hned, bez čekání na server', async () => {
    ...
    vi.mocked(childrenApi.deleteChild).mockReturnValue(new Promise(() => {}));

    const { result } = renderHook(
      () => ({
        children: useChildrenQuery().data,
        deleteChild: useDeleteChildMutation().mutate,
      }),
  ...
  it('při chybě vrátí smazané dítě zpět (rollback)', async () => {
    ...
    vi.mocked(childrenApi.deleteChild).mockReturnValueOnce(pendingDelete);
