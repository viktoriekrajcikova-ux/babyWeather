...
describe('server getWeather', () => {
    ...
    it.each([
        ...
        { name: 'chybí pocitová teplota', body: { hourly: { ...upstreamWeather.hourly, apparent_temperature: undefined } } },
        { name: 'teplota je text', body: { hourly: { ...upstreamWeather.hourly, temperature_2m: ['12'] } } },
        { name: 'neznámý WMO kód', body: { hourly: { ...upstreamWeather.hourly, weather_code: [100] } } },
